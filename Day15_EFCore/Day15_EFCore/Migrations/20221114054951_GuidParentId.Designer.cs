...
namespace Day15EFCore.Migrations
{
    ...
    [Migration("20221114054951_GuidParentId")]
    partial class GuidParentId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Day15_EFCore.DataBase.Parent", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ParentId = new Guid("753a2c01-6bc9-4345-8c76-b90c3daf895f"),
                            Address = "Konoha",
                            ParentName = "Fugaku"
                        },
                        new
                        {
                            ParentId = new Guid("8ae47d71-d036-4513-afea-00820b279388"),
                            Address = "Miyagi",
                            ParentName = "Hatake"
                        });
                });
